...
class Form(QtWidgets.QDialog):
    ...
    def __init__(self,skull_actor,skull_cut_actor,brain_actor,focus_actor,transducer_actor,a_range_actor,centerline_actor,firstline_actor,secondline_actor,finalline_actor, out_vector_actor,in_vector_actor,interactor, parent=None):
